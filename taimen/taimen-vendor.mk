...
PRODUCT_COPY_FILES += \
    ...
    vendor/google/taimen/proprietary/framework/PowerAnomalyDataModemInterface.jar:system/framework/PowerAnomalyDataModemInterface.jar \
    vendor/google/taimen/proprietary/framework/PowerAnomalyQcril.jar:system/framework/PowerAnomalyQcril.jar \
    vendor/google/taimen/proprietary/framework/VerizonUnifiedSettings.jar:system/framework/VerizonUnifiedSettings.jar \
    vendor/google/taimen/proprietary/framework/vendor.qti.qcril.am-V1.0-java.jar:system/framework/vendor.qti.qcril.am-V1.0-java.jar \
    ...
    vendor/google/taimen/proprietary/lib/libeaselcomm.so:system/lib/libeaselcomm.so \
    ...
    vendor/google/taimen/proprietary/lib64/libeaselcomm.so:system/lib64/libeaselcomm.so \
